...
<meta name="google-site-verification" content="F8035ejglUJUICdx50IYsURhIgpk7-uX7d07KWdm5PY" />
...
<?php if ( is_singular() ) wp_enqueue_script( 'comment-reply' ); ?>
  ...
  <script type="text/javascript" src="http://use.typekit.com/ndx8ozl.js"></script>
...
<?php wp_nav_menu(array('theme_location' => 'pexeto_main_menu' )); ?>
  ...
  <div class="page-container"><h1><a class="logo" href="<?php echo home_url(); ?>"></a></h1></div>
